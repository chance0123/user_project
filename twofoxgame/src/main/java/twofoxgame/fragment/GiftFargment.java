...
import http.HttpUrl;
import twofoxadapter.GiftBigAdapter;
import twofoxadapter.GiftGuessAdapter;
import twofoxfargmentbean.GiftBigGiftBean;
import twofoxfargmentbean.GiftGuessBean;
import twofoxfargmentbean.GiftHeaderBean;

/**
 * Created by chengling on 2016/10/24.
 */
public class GiftFargment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.gift_main_page_view, container, false);
        //猜你想要
